...
// // Format date function to handle decision dates
// const formatDate = (dateString) => {
//   if (!dateString || typeof dateString !== "string") {
//     console.debug("formatDate: Invalid or missing date string:", dateString);
...
//       console.debug("formatDate: Invalid Date object for:", dateString);
//       return "Not Available";
//     }
...
//     });
//   } catch (error) {
//     console.debug("formatDate: Error parsing date:", dateString, error.message);
//     return "Not Available";
//   }
// };
...
//   const filteredBenches = catBenches.filter((bench) =>
...
//             formatDate(caseItem.decisionDate).toLowerCase().includes(query))
//       );
//       setSearchResults(filtered);
//     }, 300),
//     [originalSearchResults]
...
//           caseJson.type,
//           caseJson.benchId,
//           caseJson.decisionDate ? formatDate(caseJson.decisionDate) : "",
//           new Date(caseData.followed_at).toLocaleDateString(),
//         ]
//           .filter(Boolean)
//           .join(" ")
...
//           aValue = new Date(a.followed_at);
//           bValue = new Date(b.followed_at);
//         } else if (sortConfig.key === "decisionDate") {
//           aValue = a.case_data?.decisionDate
//             ? new Date(a.case_data.decisionDate)
//             : "";
//           bValue = b.case_data?.decisionDate
//             ? new Date(b.case_data.decisionDate)
//             : "";
//         } else {
//           aValue = a.case_data?.[sortConfig.key] || "";
//           bValue = b.case_data?.[sortConfig.key] || "";
...
// Format date function to handle decision dates (kept for modal if needed)
const formatDate = (dateString) => {
  if (!dateString || typeof dateString !== "string") {
    console.debug("formatDate: Invalid or missing date string:", dateString);
    return "Not Available";
